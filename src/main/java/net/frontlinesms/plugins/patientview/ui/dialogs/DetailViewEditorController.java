...
import net.frontlinesms.plugins.patientview.data.repository.hibernate.HibernateMedicFormFieldDao;
...
public class DetailViewEditorController implements ThinletUiEventHandler{
	...
	private static final String UI_FILE_PERSON_AAG =  "/ui/plugins/patientview/AtAGlance/person_AAG.xml";
