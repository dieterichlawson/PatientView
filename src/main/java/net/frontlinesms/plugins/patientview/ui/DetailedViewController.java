...
import net.frontlinesms.plugins.patientview.data.repository.hibernate.HibernateMedicFieldDao;
import net.frontlinesms.plugins.patientview.data.repository.hibernate.HibernateMedicFieldResponseDao;
import net.frontlinesms.plugins.patientview.history.HistoryManager;
import net.frontlinesms.plugins.patientview.ui.ChartGenerator.CalcType;
import net.frontlinesms.plugins.patientview.ui.ChartGenerator.ChartType;
import net.frontlinesms.plugins.patientview.ui.ChartGenerator.TimeSpan;
import net.frontlinesms.plugins.patientview.ui.administration.AdministrationTabController;
import net.frontlinesms.plugins.patientview.ui.dialogs.DetailViewEditorController;
...
import net.frontlinesms.plugins.patientview.ui.helpers.thinletformfields.ButtonGroup;
...
public class DetailedViewController implements ThinletUiEventHandler{
	...
	private static final String UI_FILE_FORM_AAG = "/ui/plugins/patientview/AtAGlance/form_AAG.xml";
	private static String UI_FILE_PERSON_AAG_PANEL = "/ui/plugins/patientview/AtAGlance/person_AAG.xml"; 
	private static String CHART_OPTIONS = "/ui/plugins/patientview/AtAGlance/chart_options.xml"; 
	...
	public DetailedViewController(UiGeneratorController uiController, ApplicationContext appContext, PatientViewThinletTabController controller){
		//set local variables
	...
	public PatientViewThinletTabController getParent(){
		return parent;
	}
	...
	private void switchToFieldPanel(MedicField entity){
		uiController.removeAll(detailPanel);
		if(entity.getDatatype() == DataType.NUMERIC_TEXT_FIELD || entity.getDatatype().isBoolean()){
			uiController.removeAll(detailPanel);
...
//		}
	...
	public void createPatient(){
		AdministrationTabController tab = new AdministrationTabController(uiController,appContext);
