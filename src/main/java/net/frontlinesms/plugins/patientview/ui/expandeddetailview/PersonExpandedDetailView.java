...
public class PersonExpandedDetailView extends ExpandedDetailView implements AdvancedTableActionDelegate {
	...
	protected AdvancedTableController historyMessages;
	...
	public void init(){
		...
		historyMessages = new AdvancedTableController(this,uiController,false);
	...
	protected AdvancedTableController historyTable;
