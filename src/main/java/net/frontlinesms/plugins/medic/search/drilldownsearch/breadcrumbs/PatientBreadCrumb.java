...
public class PatientBreadCrumb extends BreadCrumb {
	...
	private String fieldQuery = "select distinct ff from MedicField ff,  MedicFieldResponse mfieldr, Patient p where ff = mfieldr.field and mfieldr.subject.pid =";

	private String formResponseQuery = "select mformr from MedicFormResponse mformr,  Patient p where mformr.subject = p and p.pid =";
	
	private String fieldResponseQuery = "select mfieldr from MedicFieldResponse mfieldr,  Patient p where mfieldr.subject = p and p.pid =";
