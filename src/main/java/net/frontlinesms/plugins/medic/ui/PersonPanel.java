...
public class PersonPanel implements ThinletUiEventHandler{
	...
	private static String PERSON_PANEL_XML = "/ui/plugins/medic/AtAGlance/person_AAG.xml";
	...
	private void addEditablePersonFields() {
		...
		uiController.setIcon(uiController.find(mainPanel,"imagePanel"), "/icons/medic/blank_person_edit.png");
