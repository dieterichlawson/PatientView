...
import net.frontlinesms.plugins.medic.data.repository.hibernate.HibernateHistoryEntryDao;
...
import net.frontlinesms.plugins.medic.ui.DetailedViewController;
import net.frontlinesms.plugins.medic.ui.TableActionDelegate;
