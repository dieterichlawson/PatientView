...
import net.frontlinesms.plugins.medic.ui.ResultsTableController;
...
public class QueryGenerator {
	...
	private ResultsTableController resultsTable;
	private boolean searchingForResponses;
	private int sortColumn;
	private boolean isAscending;
	private String lastSearch;
	
	public QueryGenerator(ApplicationContext appCon, ResultsTableController resultsTable){
	...
	public void startSearch(String param){
		System.out.println(SearchDescriptorGenerator.getSearchDescriptor(breadCrumbs, e, searchingForResponses));
		lastSearch = param;
		String query ="";
